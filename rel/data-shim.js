...
module.exports = AppComponent = (function() {
  ...
  function AppComponent(kind, type, scalesHorizontally, scalesRedund) {
    ...
    this.clusterable = componentData.clusterable;
    this.addGeneration();
  }
